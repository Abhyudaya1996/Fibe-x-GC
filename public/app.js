...
// Every message below is CARD-focused, not Fibe-product-focused. Hooks (H1–H12)
// are tagged inline so the reader can see which hook each notification delivers.
...
const COHORTS = [
  {
    ...
    messages: [
      { day: 1, time: '10:00 AM', type: 'push', hook: 'H3', title: '3 credit cards pre-matched to you',
      ...
      { day: 1, time: '6:00 PM', type: 'push', hook: 'H3', title: 'Axis Ace · ₹500 cashback on your first spend',
      ...
      { day: 3, time: '9:00 AM', type: 'push', hook: 'H4', title: 'Your free credit score — no PAN needed to peek',
      ...
      { day: 10, time: '10:00 AM', type: 'push', hook: 'H3', title: 'Expiring: SBI SimplyClick ₹2,000 sign-on',
      ...
      { day: 14, time: '11:00 AM', type: 'push', hook: 'H3', title: '3 lifetime free cards · 60 seconds · no fees',
        body: 'Zero joining. Zero annual. Pick 1.',
        cta: 'See all 3',
        why: 'LTF framing, speed claim. Low-cognition push.' },
      { day: 18, time: '8:00 PM', type: 'push', hook: 'H9', title: 'Salaried at ₹60K+? 3 cards your peers use',
      ...
      { day: 22, time: '7:00 PM', type: 'email', hook: 'H5', subject: '6 cards hand-picked for your profile — save up to ₹18,400/yr',
      ...
      { day: 30, time: '9:00 AM', type: 'email', hook: 'H3', subject: 'Still looking? 3 LTF cards are ready in 2 minutes',
  ...
  },
  {
    ...
    messages: [
      { day: 1, time: '9:00 AM', type: 'push', hook: 'H3', title: 'PAN verified ✓ Here are your 3 best cards',
      ...
      { day: 30, time: '11:00 AM', type: 'push', hook: 'H5', title: 'Your top-savings card this month',
  ...
  },
  {
    ...
    messages: [
      ...
      { day: 3, time: '10:00 AM', type: 'push', hook: 'H7', title: '₹50K FD = ₹50K credit line · zero joining fee',
      ...
      { day: 5, time: '8:00 PM', type: 'push', hook: 'H7', title: 'Your FD keeps earning 7.5% — card is on top',
  ...
  },
  {
    ...
    messages: [
      { day: 1, time: '11:00 AM', type: 'push', hook: 'H7', title: 'Let\'s get you approved next time',
  ...
  },
  {
    ...
    messages: [
      { day: 1, time: 'on 650→750 shift', type: 'push', hook: 'H4', title: 'Your score just unlocked 3 new cards',
      ...
      { day: 1, time: 'on 650→750 shift', type: 'push', hook: 'H4', title: '750 is the band where you save ₹20K+/yr on a card',
  ...
  extra.innerHTML = `
    <div class="grid gap-4" style="grid-template-columns: minmax(220px, 260px) 1fr">
      <div class="bg-white/5 border border-white/10 rounded-xl p-3" id="cohortListWrap">
        <p class="text-[10px] uppercase tracking-[0.18em] font-semibold text-slate-400 mb-2 px-1">Cohorts · 9</p>
